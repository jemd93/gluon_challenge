...
test_input = 'transfer 5'
# test_input = 'I would like'
...
def generate_random_text(model, input_string, seq_length, batch_size, sentence_length):
    ...
    while count < sentence_length:
        ...
        if ((len((cp_input_string + new_string).split()) >= 7) and ((cp_input_string + new_string)[-1] == ' ' or
                                                                   (cp_input_string + new_string)[-1] == '\n')):
            break
    print()
    print("Full output : " + cp_input_string + new_string)
    print("Predicted string : " + new_string)
